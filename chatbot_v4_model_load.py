...
while True: ####  chat_processor() 함수화 작업
  ...
  if key[0] and key[1]in sentence:
      answer_result_1= weather(sentence) + dust(sentence)
      client_socket.sendall(answer_result_1.encode()) 
      
  else:
      answer_result_2 = sentence_generation(sentence)
      client_socket.sendall(answer_result_2.encode())
